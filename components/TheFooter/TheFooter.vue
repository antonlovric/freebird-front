  ...
  >
    <div class="">
      ...
      <ul class="flex flex-col mb-4 mt-2 gap-2">
        <li><nuxt-link class="link" to="/history">Povijest</nuxt-link></li>
        <li><nuxt-link class="link" to="/terms">Uvjeti Korištenja</nuxt-link></li>
        <li><nuxt-link class="link" to="/privacy">Politika Privatnosti</nuxt-link></li>
        <li><nuxt-link class="link" to="/grading">Sustav Ocjenjivanja</nuxt-link></li>
      </ul>
    </div>
    <div>
      <h2>Služba za korisnike</h2>
      <ul class="flex flex-col mb-4 mt-2 gap-2">
        <li><nuxt-link class="link" to="/contact">Kontakt</nuxt-link></li>
        <li>
