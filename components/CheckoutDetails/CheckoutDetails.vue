  ...
  <div class="w-full sm:w-10/12 inline-flex flex-col items-center justify-center">
    <div class="mt-5 inline-flex flex-col sm:flex-row gap-5">
      ...
      <div class="sm:w-[300px] inline-flex flex-col">
        <h2 class="mb-3 text-center">Podaci o plaćanju</h2>
        <va-select
          v-model="order.paymentDetails.selectedShipping"
          class="block w-full mb-4 text-black"
          label="Način Dostave"
    ...
    <div class="mt-5 inline-flex flex-col sm:flex-row">
      ...
      <div v-if="!order.sameAddress" class="inline-flex items-center flex-col gap-5">
        <h2 class="text-center">Adresa za dostavu</h2>
    ...
    <div class="inline-flex flex-col sm:flex-row mt-5 px-10 gap-5 w-full">
      ...
      />
      <va-checkbox v-model="order.newsletter" label="Želim se prijaviti na FreeBird newsletter" />
    </div>
