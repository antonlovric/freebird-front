...
declare type Map<O extends Record<any, any>> = {
    [K in keyof O]: O[K];
};
/** Utility type: Check if key exist in object before access */
declare type SafeAccess<O, K> = K extends keyof O ? O[K] : never;
/** List of all exported components */
export declare type VuesticComponentsMap = Map<typeof vuesticComponents>;
/** Component names */
 ...
 * */
export declare type VuesticComponents<NAMES extends string = VuesticComponentName> = {
