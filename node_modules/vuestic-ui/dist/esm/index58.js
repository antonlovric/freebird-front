  ...
  return (openBlock(), createElementBlock("div", _hoisted_1, [
    createElementVNode("div", _hoisted_2, [
      createElementVNode("div", {
        ...
        onWheel: _cache[0] || (_cache[0] = (...args) => ($options.scroll && $options.scroll(...args))),
        onTouchstart: _cache[1] || (_cache[1] = (...args) => ($options.startDrag && $options.startDrag(...args))),
        onTouchmove: _cache[2] || (_cache[2] = (...args) => ($options.onDrag && $options.onDrag(...args))),
        onTouchend: _cache[3] || (_cache[3] = (...args) => ($options.stopDrag && $options.stopDrag(...args))),
        onTransitionend: _cache[4] || (_cache[4] = (...args) => ($options.onContentResize && $options.onContentResize(...args)))
      }, [
...
script.__file = "src/components/va-scrollbar/VaScrollbar.vue";

const VaScrollbar = withConfigTransport(script);
